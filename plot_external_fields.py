...
for molec in molec_list :
    files.append('small_helix_'+molec+'/fields/external_field.weighted.out')
...
plt.xlabel('Peptide') 
plt.ylabel(r"Calculated external field ($\frac{k_B T}{e^- \AA}$)") 

plt.savefig("external_field.pdf", format='pdf') 
